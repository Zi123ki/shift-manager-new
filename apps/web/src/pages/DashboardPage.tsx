...
import { Calendar, Clock, Users, Building2, UserMinus, TrendingUp } from 'lucide-react';
            ...
            <Card key={index} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-4 md:p-6">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-3 md:space-y-0">
                  ...
                  <div className={`${stat.bgColor} p-2 md:p-3 rounded-full flex-shrink-0 self-end md:self-auto`}>
