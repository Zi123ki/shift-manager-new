      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center">
            <Users className="h-5 w-5 ml-2 rtl:ml-0 rtl:mr-2" />
            רשימת עובדים
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="h-96 flex items-center justify-center border-2 border-dashed border-muted-foreground/25 rounded-lg">
            <div className="text-center text-muted-foreground">
              ...
              <p className="text-lg font-medium">ניהול עובדים</p>
              <p className="text-sm">כאן תוכלו לנהל את רשימת העובדים</p>
            </div>
          </div>
        </CardContent>
      </Card>
